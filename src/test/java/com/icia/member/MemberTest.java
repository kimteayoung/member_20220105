...
public class MemberTest {
    ...
    @Test
    @Transactional // 테스트 시작할 때 새오운 트랜잭션 시작
    ...
    public void memberDetailTest(){
        ...
        // 1.1 테스트용 데이터 객체 생성
        MemberSaveDTO memberSaveDTO = new MemberSaveDTO("조회용 회원 이메일", "조회용 회원 비번", "조회용 회원 이름");
        ...
        assertThat(memberSaveDTO.getM_email()).isEqualTo(findMember.getM_email());
    }
}
